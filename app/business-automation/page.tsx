...
const solutions = [
  {
    ...
    description:
      "Automate repetitive business workflows and connect your everyday tasks so your team can work faster and more efficiently.",
  },
  {
    icon: "📋",
    title: "Lead Management",
    description:
      "Capture, organize and manage leads automatically so potential customers are followed up at the right time.",
  },
  {
    icon: "🤖",
    title: "AI Customer Support",
    description:
      "Automate common customer questions and support requests with intelligent AI-powered systems available 24/7.",
  },
  {
    icon: "🔗",
    title: "Business Integrations",
    description:
      "Connect websites, forms, CRM systems, messaging platforms and other business tools into one automated workflow.",
  },
  {
    icon: "📊",
    title: "Data Automation",
    description:
      "Automatically collect, organize and move business information between your systems with fewer manual steps.",
  },
  {
    icon: "🧠",
    title: "Custom Automation",
    description:
      "Get an automation system designed specifically around your business processes, goals and operational requirements.",
  },
];
...
const benefits = [
  {
    icon: "⏱️",
    title: "Save Time",
    text: "Automate repetitive work and give your team more time to focus on important business activities.",
  },
  {
    icon: "💰",
    title: "Reduce Costs",
    text: "Reduce manual processes, minimize errors and improve operational efficiency.",
  },
  {
    icon: "🚀",
    title: "Work Faster",
    text: "Create faster workflows that help your business respond to customers and leads more efficiently.",
  },
  {
    icon: "🌍",
    title: "24/7 Automation",
    text: "Let automated systems continue working around the clock, even when your team is offline.",
  },
];
...
const process = [
  {
    number: "01",
    title: "Understand",
    text: "We learn how your business currently works and identify repetitive tasks and bottlenecks.",
  },
  {
    number: "02",
    title: "Plan",
    text: "We design an automation workflow based on your business goals and requirements.",
  },
  {
    number: "03",
    title: "Build",
    text: "We build and connect the required tools, systems and automation workflows.",
  },
  {
    number: "04",
    title: "Launch",
    text: "We deploy the automation and help you improve the system as your business grows.",
  },
];
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-7 max-w-3xl text-base leading-8 text-gray-300 sm:text-lg">
              Automate repetitive tasks, connect your business systems and
              create intelligent workflows that save time, reduce costs and
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-2xl shadow-cyan-500/5 sm:p-8">
              ...
              <div className="relative grid gap-5 md:grid-cols-3">
                ...
                <div className="rounded-2xl border border-blue-500/20 bg-[#111A2C] p-6">
                  ...
                  <p className="mt-2 text-sm leading-6 text-gray-400">
                    Connect your tools and systems into smart workflows.
                  </p>
                </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-gray-400">
              Practical automation solutions designed to solve real business
              problems and eliminate unnecessary manual work.
            </p>
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-xl leading-8 text-gray-400">
                Business automation removes repetitive manual processes and
                allows your team to focus on customers, strategy and growth.
              </p>
        ...
        <div className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl border border-cyan-500/20 bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-indigo-600/10 px-6 py-14 text-center sm:px-10">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-5 max-w-2xl leading-8 text-gray-400">
              Tell us which tasks or processes you want to automate. We will
              help you find a practical AI-powered automation solution.
            </p>
